/*
 Product Module Tables for H2 Test Environment

 This file is used for unit testing with H2 in-memory database (MySQL mode).
 For production MySQL environment, please use: sql/mysql/product_tables.sql

 Note: This file does NOT include character set definitions because H2 does not support them.
       For production MySQL, use the file in sql/mysql/ which includes utf8mb4 character set
