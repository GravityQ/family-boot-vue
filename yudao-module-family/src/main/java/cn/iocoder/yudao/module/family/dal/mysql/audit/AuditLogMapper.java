...
public interface AuditLogMapper extends BaseMapperX<AuditLogDO> {
    ...
    default PageResult<AuditLogDO> selectPageByFamilyIdAndStatus(Long familyId, Integer auditStatus, Integer pageNo, Integer pageSize) {
        return selectPage(pageNo, pageSize, new LambdaQueryWrapperX<AuditLogDO>()
